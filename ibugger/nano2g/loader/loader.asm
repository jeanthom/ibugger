...
mainloop:
  ...
  BEQ noreset
    ...
    MOV R2, #0x08100000
    STR R2, [R8,#0xB14]        @ USB2 Gadget: Endpoint 0 OUT DMA Address: 0x08100000
    LDR R2, [R8,#0xB00]
    ...
    MOV R2, #0x08300000
    STR R2, [R8,#0xB94]        @ USB2 Gadget: Endpoint 4 OUT DMA Address: 0x08300000
    LDR R2, [R8,#0xB80]
...
ctrlsend:
  BL flushcache
  MOV R0, #0x08200000        @ Buffer to be sent
  MOV R2, #0x00009800
...
strings:
.ascii "Unified iBugger Loader v0.1.1\0"
.ascii "running on iPod Nano 2G\0"
.ascii "Copyright 2010 TheSeven\0"
.ascii "http://l4n.clustur.com/\0"
.ascii "USB init...\0"
.ascii " OK\0"
.align 2
